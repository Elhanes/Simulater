...
PgwBinder* getPgwBinder()
{
    return check_and_cast<PgwBinder*>(getSimulation()->getModuleByPath("pgwbinder"));
}

PgwBinder2* getPgwBinder2()
{
    return check_and_cast<PgwBinder2*>(getSimulation()->getModuleByPath("pgwbinder2"));
}
