...
Define_Module(VoIPSender2);

VoIPSender2::VoIPSender2()
{
    initialized_ = false;
    selfSource_ = NULL;
    selfSender_ = NULL;
...
void VoIPSender2::initialize(int stage)
{
...
void VoIPSender2::handleMessage(cMessage *msg)
{
...
void VoIPSender2::talkspurt(simtime_t dur)
{
    iDtalk_++;
...
void VoIPSender2::selectPeriodTime()
{
    if(state){
    if (!isTalk_)
    {
...
void VoIPSender2::sendVoIPPacket()
{
