...
#include <cmath>
#include "apps/voip/VoIPSender4.h"

#define round(x) floor((x) + 0.5)

Define_Module(VoIPSender4);

VoIPSender4::VoIPSender4()
{
    initialized_ = false;
    selfSource_ = NULL;
    selfSender_ = NULL;
...
void VoIPSender4::initialize(int stage)
{
...
void VoIPSender4::handleMessage(cMessage *msg)
{
...
void VoIPSender4::talkspurt(simtime_t dur)
{
    iDtalk_++;
...
void VoIPSender4::selectPeriodTime()
{
    if(state){
    if (!isTalk_)
    {
...
void VoIPSender4::sendVoIPPacket()
{
