...
#include "epc/gtp/GtpUserSimplified_PGW.h"
#include "inet/networklayer/contract/ipv4/IPv4ControlInfo.h"
#include "inet/networklayer/common/L3AddressResolver.h"
#include <iostream>

Define_Module(GtpUserSimplified_PGW);

void GtpUserSimplified_PGW::initialize(int stage)
{
    ...
    //HAEIN get the address of the PGW for itself
       pgwAddress_ = L3AddressResolver().resolve(getParentModule()->getFullName());
}

EpcNodeType GtpUserSimplified_PGW::selectOwnerType(const char * type)
{
...
void GtpUserSimplified_PGW::handleMessage(cMessage *msg)
{
...
void GtpUserSimplified_PGW::handleFromTrafficFlowFilter(IPv4Datagram * datagram)
{
...
void GtpUserSimplified_PGW::handleFromUdp(GtpUserMsg * gtpMsg)
{
