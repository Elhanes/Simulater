...
#ifndef _LTE_TRAFFICFLOWFILTERSIMPLIFIED4_H_
#define _LTE_TRAFFICFLOWFILTERSIMPLIFIED4_H_
 ...
 */
class TrafficFlowFilterSimplified4 : public cSimpleModule
{
    ...
    std::map<L3Address, MacNodeId> UEAddresstoMacNodeId_;
    MacNodeId UENodeID[2]={0,};
  protected:
    ...
    MacNodeId checkingUE(L3Address srcAddress);
    int registerUE(L3Address srcAddress);
