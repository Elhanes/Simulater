...
#include "epc/TrafficFlowFilterSimplified2.h"
#include "inet/networklayer/contract/ipv4/IPv4ControlInfo.h"
#include "inet/networklayer/ipv4/IPv4Datagram.h"
#include "inet/networklayer/common/L3AddressResolver.h"

Define_Module(TrafficFlowFilterSimplified2);

void TrafficFlowFilterSimplified2::initialize(int stage)
{
...
EpcNodeType TrafficFlowFilterSimplified2::selectOwnerType(const char * type)
{
...
void TrafficFlowFilterSimplified2::handleMessage(cMessage *msg)
{
...
TrafficFlowTemplateId TrafficFlowFilterSimplified2::findTrafficFlow(L3Address srcAddress, L3Address destAddress)
{
...
MacNodeId TrafficFlowFilterSimplified2::checkingUE(L3Address srcAddress){
...
int TrafficFlowFilterSimplified2::registerUE(L3Address srcAddress){  //register UE to UENodeID UENodeID[0] is to gtpgate0, UENodeID[1] is to gtpgate
...
void TrafficFlowFilterSimplified2::refreshDisplay() const{
    char buf[100];
    int len=0;
